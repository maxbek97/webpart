  ...
  return (
    <section id="tech" className="tech-section">
      <div className='tech-box'>
        ...
        <TechTile iconName='fastapi-logo-png.png' description='Фреймоворк для быстрого создания и настройки WebSocket-сервера'></TechTile>
        <TechTile iconName='OpenCV.svg' description='Открытая библиотека для использования компьютерного зрения'></TechTile>
        <TechTile iconName='kotlin-logo.png' description='Актуальный язык для написания приложения для Android'></TechTile>
      </div>
    </section>
  );
};
